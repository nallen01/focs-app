...
public class AllZoneScorerFragment extends Fragment implements DataListener {
    private ScorerLocation scorerLocation;
    private TcpClient tcpClient;
    private View rootView;
    private boolean isFlipped = false;

    public static AllZoneScorerFragment newInstance(ScorerLocation scorerLocation, boolean flip) {
        AllZoneScorerFragment fragment = new AllZoneScorerFragment();
        fragment.assignFlipped(flip);
        fragment.assignScorerLocation(scorerLocation);
        return fragment;
    }

    public AllZoneScorerFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(isFlipped) {
            rootView = inflater.inflate(R.layout.fragment_all_zone_scorer_flip, container, false);
        }
        else {
            rootView = inflater.inflate(R.layout.fragment_all_zone_scorer, container, false);
        }
